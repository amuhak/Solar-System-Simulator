...
inline constexpr CelestialObject sol = CelestialObject(
    ...
    8.441015570617839E-03 * 1000,
    -1.221912229517152E-02 * 1000,
    -7.918736754502012E-05 * 1000,
    1.98855E+30,
    695660 * 1000,
    "Sun"
);
...
inline constexpr CelestialObject mercurius = CelestialObject(
    ...
    -3.865601391340655E+01 * 1000,
    -3.734598383776862E+01 * 1000,
    4.954276669322102E-01 * 1000,
    3.3011E+23,
    2439.7 * 1000,
    "Mercury"
);
...
inline constexpr CelestialObject venus = CelestialObject(
    ...
    3.517776985981810E+00 * 1000,
    -3.499021677262173E+01 * 1000,
    -6.829385946234794E-01 * 1000,
    4.8675E+24,
    6051.8 * 1000,
    "Venus"
);
inline constexpr CelestialObject terra = CelestialObject(
    ...
    -2.983351607599674E+01 * 1000,
    -5.135525753507316E+00 * 1000,
    1.103959339770366E-03 * 1000,
    5.9722E+24,
    6371 * 1000,
    "Earth"
);
...
inline constexpr CelestialObject luna = CelestialObject(
    ...
    -3.024438898825232E+01 * 1000,
    -6.010660216416693E+00 * 1000,
    -5.808542579651466E-02 * 1000,
    7.342E+22,
    1737.4 * 1000,
    "Moon (Earth)"
);
...
inline constexpr CelestialObject mars = CelestialObject(
    ...
    2.466995826568801E+01 * 1000,
    -2.736343890484162E+00 * 1000,
    -6.620925260729528E-01 * 1000,
    6.4171E+23,
    3389.5 * 1000,
    "Mars"
);
...
inline constexpr CelestialObject iuppiter = CelestialObject(
    ...
    -9.472330329859803E+00 * 1000,
    9.770254241116218E+00 * 1000,
    1.713410188865314E-01 * 1000,
    1.8982E+27,
    69911 * 1000,
    "Jupiter"
);
...
inline constexpr CelestialObject saturnus = CelestialObject(
    ...
    3.154994095652995E+00 * 1000,
    8.905566499358839E+00 * 1000,
    -2.800166767406997E-01 * 1000,
    5.6834E+26,
    58232 * 1000,
    "Saturn"
);
...
inline constexpr CelestialObject uranus = CelestialObject(
    ...
    -5.363307238645053E+00 * 1000,
    3.942270462274153E+00 * 1000,
    8.415494743780227E-02 * 1000,
    86.813E+24,
    25362 * 1000,
    "Uranus"
);
...
inline constexpr CelestialObject neptunus = CelestialObject(
    ...
    2.903902879855819E-01 * 1000,
    5.457709778431394E+00 * 1000,
    -1.190948298321868E-01 * 1000,
    102.409E+24,
    24624 * 1000,
    "Neptune"
);
